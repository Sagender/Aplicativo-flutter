...
class DetalleDestinocreen extends StatelessWidget {
  const DetalleDestinocreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
          ...
          children: [
            Background(),
            SafeArea(child: _Detalle()),
            SafeArea(child: _Detalle1()),
            _Regresar(),
            _Regresar1()
          ]),
    );
...
class _Detalle1 extends StatelessWidget {
  const _Detalle1({
    Key? key,
  }) : super(key: key);
...
class _Regresar1 extends StatelessWidget {
  const _Regresar1({
    Key? key,
  }) : super(key: key);
